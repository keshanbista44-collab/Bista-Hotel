...
export default function Header({ scrollRef, forceLight = false }: HeaderProps) {
  ...
  const overHero = overHeroRaw && !forceLight && isHomePage
  ...
  return (
    ...
    >
      ...
      <nav style={{ display: 'flex', alignItems: 'stretch', height: '100%' }}>
        <NavItem label="Home" overHero={overHero} to="/" />
        <NavItem label="Rooms" overHero={overHero} to="/rooms" />
        <NavItem label="Gallery" overHero={overHero} to="/gallery" />
        <NavItem label="About" overHero={overHero} to="/about" />
        <NavItem label="Contact" overHero={overHero} to="/contact" />
